  ...
  return (
    <FormContainer>
      ...
      <InputGroup>
        ...
        <TextArea body={props.body} onChange={props.onChange} />
      </InputGroup>

      <CheckBox agree={props.agree} onToggleAgree={props.onToggleAgree} />
      ...
      <ButtonBox>
        <Button submit={true} onClick={props.onSubmitQuestion}>
          전송하기
        </Button>
      </ButtonBox>
    </FormContainer>
